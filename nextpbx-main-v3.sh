...
# Author: A-Lang
# Updated by 2017-02-26
#
export PATH="/usr/bin:/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/sbin"
CURDIR=`pwd`
URL_nextpbx="http://demo.osslab.tw:8880/myfiles/nextradio_pbx/target_NextPBX_by_osslab_current.tgz"
URL_nextradio_v2="http://demo.osslab.tw:8880/myfiles/nextradio_pbx/nextradio_v2_rootfs.tgz"
...
main_menu(){
   ...
   echo "(2) NextRadio V2 - An Internet Radio System(New)"
   echo ""
